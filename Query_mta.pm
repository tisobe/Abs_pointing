...
#  Revision:
#     $Id: Query_mta.pm,v 1.1 2006/03/31 15:17:57 mta Exp $
...
=head1 SYNOPSIS
  ...
  $query = new Query_mta( Target  => $object,
                                     RA      => $ra,
                                     Dec     => $dec,
                                     Error   => $radius,
                                     Units   => $radius_units,
  ...
  $other = new Query_mta( Target  => $object );
...
valid frames are "ICRS" and "FK5", if not specified it will default to ICRS.
...
sub configure {
  ...
  # Frame 1, ICRS 2000/2000
  ${$self->{OPTIONS}}{"Frame1"}             = "ICRS";
  ${$self->{OPTIONS}}{"Equi1"}              = "2000.0";
  ${$self->{OPTIONS}}{"Epoch1"}             = "2000.0";
  
  # Frame 2, FK5 2000/2000
  ${$self->{OPTIONS}}{"Frame2"}             = "FK5";
  ${$self->{OPTIONS}}{"Equi2"}              = "2000.0";
  ${$self->{OPTIONS}}{"Epoch2"}             = "2000.0";
